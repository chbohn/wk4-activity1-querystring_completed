package wk4.activity1.querystring;
...
import wk4.activity1.querystring.configs.ConfigsModel;
import wk4.activity1.querystring.configs.ExampleConfigs;
...
public class ExampleService {
    public static ExampleService exampleService;

    private static Connection con = null;
    private static ExampleConfigs configs = new ExampleConfigs();
    ...
    private void getConfigFile(String configFile) {
        try {
            ...
            configs = new ExampleConfigs(loadExampleConfigs(configFile));
    ...
    private ConfigsModel loadExampleConfigs(String file) {
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("wk4.activity1.querystring.resources");
    ...
    public static ExampleConfigs getExampleConfigs() {
        return configs;
    }
}
