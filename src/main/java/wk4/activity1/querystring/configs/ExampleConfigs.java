...
public class ExampleConfigs {
    ...
    public ExampleConfigs() { }

    public ExampleConfigs(ConfigsModel cm) throws NullPointerException {
        if (cm == null) {
            throw new NullPointerException("Unable to create ExampleConfigs from ConfigsModel.");
        } else {
            // Set service configs
